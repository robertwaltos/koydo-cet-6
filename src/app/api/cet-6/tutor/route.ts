...
const EXAM_ID = "cet-6";
const EXAM_DISPLAY_NAME = "英语六级 (CET-6 — College English Test Band 6)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. 用中文解释，英文示例。

覆盖CET-6的听力、阅读、写作和翻译四个部分。侧重高级词汇、长难句阅读和学术写作技巧。
