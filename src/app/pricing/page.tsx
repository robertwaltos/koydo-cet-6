...
export const metadata: Metadata = {
  title: "Pricing — Cet 6 Premium",
  description: "Unlock unlimited Cet 6 practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=cet-6&cadence=annual`;
