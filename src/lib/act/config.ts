// Auto-generated shim — re-exports from @/lib/cet-6/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _cet_6_Config } from "@/lib/cet-6/config";
import { EXAM_CONFIG as _raw } from "@/lib/cet-6/config";
